      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/products" className="text-white px-7 py-3 bg-orange-400 font-semibold rounded-full hover:bg-orange-500 transition-all flex-center gap-2 active:scale-[0.98]">
              Show Now  <ArrowRightIcon className="size-4" />
            </Link>
            <Link to="/products" className="text-white px-7 py-3 bg-white/10 font-semibold rounded-full hover:bg-white/20 transition-all border border-white/20">
              Browse Categories
            </Link>
          </div>
        </div>
