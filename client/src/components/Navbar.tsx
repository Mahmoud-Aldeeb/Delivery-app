...
const Navbar = () => {
  const user: any =
  { name: "Mahmoud Aldeeb", email: "mahmoudaldeeb@gmail.com", isAdmin: true }
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              {user ? (
                ...
                : (
                  <div className="flex-center gap-2" onClick={() => setUserMenuOpen(!userMenuOpen)}>
                    ...
                    {userMenuOpen ? <XIcon className="md:hidden" onClick={() => setUserMenuOpen(!userMenuOpen)} /> : <MenuIcon className="md:hidden" />}
                  </div>
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                    {user && (
                      <div className="px-4 py-2 border-b border-r-app-border">
                    ...
                    <div onClick={() => setUserMenuOpen(false)}>
                      ...
                      {user?.isAdmin && (
                        <Link to='/admin/products' className="dropdown-link"><ShieldIcon className="text-app-orange-dark" size={16} /> <span className="text-app-orange-dark">Admin</span></Link>
                      )}
