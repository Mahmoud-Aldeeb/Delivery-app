  ...
  return <div className="min-h-screen flex">
    ...
    <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
      ...
      <div className="relative text-center px-12">
        <h1 className="text-4xl font-semibold text-white mb-4">Welcome back to Instacart</h1>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-app-text-light">
            ...
            <button onClick={() => setIsLoginState(!isLoginState)} className="ml-1 text-orange-500 font-semibold hover:text-orange-600 transition-colors">
          ...
          {!isLoginState && (
            <label htmlFor="name" className="text-sm flex flex-col gap-1">Name
              <div className="relative">
                ...
                <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} required placeholder="Your Name" className="w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all" />
              </div>
            </label>
          )}
          <label htmlFor="email" className="text-sm flex flex-col gap-1">ُEmail Address
            <div className="relative">
              <MailIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 size-4 text-app-text-light" />
              <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="you@example.com" className="w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all" />
            </div>
          </label>
          <label htmlFor="password" className="text-sm flex flex-col gap-1">Password
            <div className="relative">
