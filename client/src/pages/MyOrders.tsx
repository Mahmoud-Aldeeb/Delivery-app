...
import { CalendarRangeIcon, ChevronRightIcon, PackageIcon } from "lucide-react";
...
const MyOrders = () => {
  ...
  const fetchOrders = async () => {
    ...
    setLoading(true)
    try {
      const params = activeTap !== "all" ? `?status=${activeTap}` : "";
  ...
  return <div className="min-h-screen bg-app-cream mb-20">
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
        {tabs.map((tab) => (
          <button key={tab} onClick={() => setActiveTab(tab)} className=
            ...
            ${activeTap === tab ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}
          ...
          {orders.map((order) => (
            ...
            transition-all">
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <CalendarRangeIcon className="size-3 text-app-text-light" />
              ...
              <div className="flex justify-between items-center pt-3 text-sm">
                ...
                <span className="text-app-green font-semibold">{currency}{order.total.toFixed(2)} </span>
